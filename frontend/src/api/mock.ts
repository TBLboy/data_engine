...
export const taskTypes: TaskType[] = [
  { id: 'double_hand_grasp', name: '双臂灵巧手抓取', description: 'TeleDex 双臂 + 双灵巧手采集任务', armMode: 'both_arms', isActive: true, totalBatches: 8, totalEpisodes: 426 },
  { id: 'transfer_place', name: '转运放置', description: '抓取、转运、放置完整流程', armMode: 'both_arms', isActive: true, totalBatches: 5, totalEpisodes: 218 },
  { id: 'drawer_open', name: '抽屉开合', description: '含接触、拉拽和终态判断', armMode: 'right_arm', isActive: true, totalBatches: 3, totalEpisodes: 96 }
]
...
export const episodes: EpisodeRow[] = [
  { id: 'episode_000124', batchId: 'batch_20260622_001', batchName: '2026-06-22 上午入库', taskName: '双臂灵巧手抓取', durationSec: 42.3, frameCount: 1269, qcStatus: 'new', qcResult: 'pending', finalDatasetStatus: 'PENDING', finalDecisionSource: 'PENDING_NOT_ADJUDICATED', reviewer: '-', reasonCode: '-', updatedAt: '2026-06-22 09:42' },
  { id: 'episode_000125', batchId: 'batch_20260622_001', batchName: '2026-06-22 上午入库', taskName: '双臂灵巧手抓取', durationSec: 39.8, frameCount: 1194, qcStatus: 'assigned', qcResult: 'pending', finalDatasetStatus: 'PENDING', finalDecisionSource: 'PENDING_NOT_ADJUDICATED', reviewer: '李审核', reasonCode: '-', updatedAt: '2026-06-22 09:44' },
  { id: 'episode_000126', batchId: 'batch_20260621_002', batchName: '2026-06-21 下午入库', taskName: '双臂灵巧手抓取', durationSec: 45.1, frameCount: 1353, qcStatus: 'done', qcResult: 'pass', finalDatasetStatus: 'QUALIFIED', finalDecisionSource: 'MANUAL_PASS', reviewer: '张审核', reasonCode: '-', updatedAt: '2026-06-21 18:02' },
  { id: 'episode_000127', batchId: 'batch_20260621_002', batchName: '2026-06-21 下午入库', taskName: '双臂灵巧手抓取', durationSec: 37.6, frameCount: 1128, qcStatus: 'done', qcResult: 'fail', finalDatasetStatus: 'UNQUALIFIED', finalDecisionSource: 'MANUAL_FAIL', reviewer: '张审核', reasonCode: 'occlusion_object', updatedAt: '2026-06-21 18:08' },
  { id: 'episode_000128', batchId: 'batch_20260620_001', batchName: '2026-06-20 稳定性复采', taskName: '双臂灵巧手抓取', durationSec: 41.7, frameCount: 1251, qcStatus: 'done', qcResult: 'fail', finalDatasetStatus: 'UNQUALIFIED', finalDecisionSource: 'MANUAL_FAIL', reviewer: '李审核', reasonCode: 'tracking_error', updatedAt: '2026-06-20 16:21' },
  { id: 'episode_000129', batchId: 'batch_20260622_001', batchName: '2026-06-22 上午入库', taskName: '双臂灵巧手抓取', durationSec: 44.6, frameCount: 1338, qcStatus: 'in_review', qcResult: 'pending', finalDatasetStatus: 'PENDING', finalDecisionSource: 'PENDING_NOT_ADJUDICATED', reviewer: '赵审核', reasonCode: '-', updatedAt: '2026-06-22 10:04' },
  { id: 'episode_000130', batchId: 'batch_20260619_001', batchName: '转运放置第一批', taskName: '转运放置', durationSec: 51.2, frameCount: 1536, qcStatus: 'done', qcResult: 'pass', finalDatasetStatus: 'QUALIFIED', finalDecisionSource: 'MANUAL_PASS', reviewer: '李审核', reasonCode: '-', updatedAt: '2026-06-19 19:20' },
  { id: 'episode_000131', batchId: 'batch_20260618_003', batchName: '抽屉开合补采', taskName: '抽屉开合', durationSec: 34.9, frameCount: 1047, qcStatus: 'done', qcResult: 'fail', finalDatasetStatus: 'UNQUALIFIED', finalDecisionSource: 'MANUAL_FAIL', reviewer: '赵审核', reasonCode: 'task_incomplete', updatedAt: '2026-06-18 16:12' }
]
